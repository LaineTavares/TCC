...
public class CadastroIngrediente extends Activity{
    ...
    { 
        ...
        btnSalvarIngrediente.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				String nomeIngrediente = txtNomeIngrediente.getText().toString();
				String precoIngrediente = txtPrecoIngrediente.getText().toString();
				Ingrediente ingrediente = new Ingrediente(nomeIngrediente, 1, precoIngrediente);
	...
	public void insereIngrediente(Ingrediente ingrediente)
    {
      tccDao = TccDao.getInstance(this);
 		Log.d("ingrediente",
				"salvando ingrediente -> " + ingrediente.getId() + " -> "
