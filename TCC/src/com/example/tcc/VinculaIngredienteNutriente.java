...
public class VinculaIngredienteNutriente extends Activity{
	...
	private void montaListaNutriente(){
		...
		adapterNutriente = new ArrayAdapter<Nutriente>(this, android.R.layout.simple_spinner_item, listaNutriente);
		adapterNutriente.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
	...
	private void montaListaIngrediente(){
		...
		adapterIngrediente = new ArrayAdapter<Ingrediente>(this, android.R.layout.simple_spinner_item, listaIngrediente);
    ...
    { 
        ...
        btnSalvar.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				Ingrediente i = (Ingrediente)spinnerIngrediente.getSelectedItem();
				Nutriente n = (Nutriente)spinnerNutriente.getSelectedItem();
				
				Ingrediente_Nutriente ing_nutri = new Ingrediente_Nutriente(1, i, n, porc);
