...
public class CadastroAnimal extends Activity {
	...
	private void montaLista(){
        ...
        adapter = new ArrayAdapter<TipoAnimal>(this, android.R.layout.simple_spinner_item, listaExemplo); 
    ...
    public void insereAnimal(Animal animal)
    {
        tccDao = TccDao.getInstance(this);
   		Log.d("animal",
  				"salvando animal -> " + animal.getId() + " -> "
  						+ animal.getNome());
  		tccDao.salvar(animal);
  		List<Animal> animais= tccDao.recuperarTodasAnimal();
